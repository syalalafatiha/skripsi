            ...
            <div class="card shadow">
                <div class="bg-info card-header">
                    <div class="d-flex align-items-center">
                        <h6 class="m-0 font-weight-bold text-white">Tambah Data Sub-Kriteria Penilaian</h6>
                    </div>
                </div>
                <div class="card-body">
                    <p>Isi formulir data sub-kriteria dengan benar, pastikan memilih kriteria yang relevan dan berikan nilai
                        yang sesuai dengan prioritas kriteria seleksi!</p>
                    <!-- // Form -->
                    <form action="{{ route('sub-kriteria.store') }}" method="POST">
                        ...
                        <table cellpadding="8" class="w-100">
                            ...
                            <tr>
                                ...
                                <td><input class="form-control" type="number" name="nilai" id="nilai" required></td>
                            </tr>
                        </table>
                        <div class="text-center mt-4">
                            <input class="btn btn-success" type="submit" name="tambah_sub_kriteria" value="Simpan">
